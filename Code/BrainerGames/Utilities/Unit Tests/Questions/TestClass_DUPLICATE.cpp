...
void TTestClass_DUPLICATE::sequentialQuestionTests(unsigned int _ui_TestType,
...
void TTestClass_DUPLICATE::TotalRoundCycleTests_Text(TQuestionReaderWriter& _QuestionReaderWriter, const TSetupInfo& _SetupInfo)
{
  string Question;
  string Answer; 
  set<string> Answers;
...
void TTestClass_DUPLICATE::TotalRoundCycleTests_Radio(TQuestionReaderWriter& _QuestionReaderWriter, const TSetupInfo& _SetupInfo)
{
  string Question;
  string Answer; 
